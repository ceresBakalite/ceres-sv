...
(function(slideview)
{
    ...
    window.ceres.csvTabImage = function(el) { tabImage(el); }; // global scope method reference
    window.ceres.csvGetSlide = function(target, calc) { getSlide(csv.index = (calc) ? csv.index += target : target); };  // global scope method reference
