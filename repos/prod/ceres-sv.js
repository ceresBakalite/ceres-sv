...
(function(slideview)
{
    ...
    window.csvTabImage = function(el) { ceres.tabImage(el); }; // global scope method reference
    window.csvGetSlide = function(target, calc) { ceres.getSlide(csv.index = (calc) ? csv.index += target : target); };  // global scope method reference
