...
(function(slideview)
{
    ...
    slideview.defaultCSS = 'https://ceresbakalite.github.io/ceres-sv/repos/prod/ceres-sv.css'; // public attribute pointing to the default slideview stylesheet
...
//        let cssArray = (slideview.csvCSS) ? slideview.csvCSS.trim().replace(/,/gi, ';').split(';') : null;
        ...
        let cssArray = (slideview.csvCSS) ? slideview.csvCSS.replace(/[^\x00-\xFF]| /g, '').split(';') : null;
