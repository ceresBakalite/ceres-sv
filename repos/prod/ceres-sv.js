...
(function(slideview)
{
    ...
    function getSlideView()
    {
        ...
        for (let item = 0; item < csv.imageArray.length; item++)
        {
            ...
            composeElement('img', elements.imgName, 'slide', csv.slideContainer, null, 'slideview.tabImage(this);', getURL(), getAccessibilityText())
            if (csv.attribute.sub) composeElement('div', elements.subName, 'subtitle', csv.slideContainer, getSubtitle(), null, null, null);
        }

        composeElement('a', 'slideview-prev', 'prev', csv.imageContainer, '&#10094;', 'slideview.getSlide(-1, true)', getURL(), null);
        composeElement('a', 'slideview-next', 'next', csv.imageContainer, '&#10095;', 'slideview.getSlide(1, true)', getURL(), null);
