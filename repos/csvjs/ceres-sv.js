...
(() => {
        ...
        async connectedCallback() {
            ...
            function initialise(csvRoot) {
                ...
                (function() { // methods belonging to the attribute object
                    ...
                    const csv = rsc.elementName({ nodeName: csvRoot }); // the UTF-16 lowercase element name in the HTML namespace
                        ...
                        textArray: () => {
                            ...
                            const getImageList = () => {
                                ...
                                const lightList = () => {
                                    ...
                                    const text = rsc.elementName({ nodeName: cfg.template }) != 'template' ? cfg.template.textContent : cfg.template.content.textContent;
    ...
    function rscMethods() {
        ...
        (function() { // methods belonging to the resource object
            ...
            this.elementName  = el => el.tagName || el.nodeName;
