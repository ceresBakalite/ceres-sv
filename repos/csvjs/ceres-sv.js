        ...
        async connectedCallback()
        {
            ...
            function getSlideView()
            {
                ...
                for (let item = 0; item < config.imageArray.length; item++)
                {
                    ...
                    rsc.composeElement({ el: 'img', id: elements.imgName, classValue: 'slide', parent: slideContainer, onClickEvent: 'window.ceres.getImage(this);', url: getURL(), accessibility: getAccessibilityText() });
