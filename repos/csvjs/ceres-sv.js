                ...
                (function() { // methods belonging to the attribute object
                    ...
                    this.instance = { // an instance of the custom HTMLElement extension
                        ...
                        eventAction: el => {
                            ...
                            rsc.elementName(el) === 'img' ? rsc.srcOpen({ node: el, type: 'image' }) : atr.get.slide({ node: el });
                        }
                    ...
                    this.compose = { // compose the custom HTMLElement extension
                        ...
                        body: () => {
                            ...
                            const setImageEvent = cfg.node.zoom ? rsc.ignore(cfg.node.clickevent) ? setSlideEvent : cfg.node.clickevent : null;
