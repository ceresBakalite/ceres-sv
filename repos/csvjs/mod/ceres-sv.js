...
(function()
{
    ...
    function getSlideView()
    {
        ...
        csl.inspect({ type: csl.constant.notify, notification: resource.attribute.ProgenitorInnerHTML + csl.parseHTML(csv.progenitor.innerHTML), logtrace: csv.attribute.trace });
