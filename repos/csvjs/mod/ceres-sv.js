...
(function()
{
    ...
    function getSlideView()
    {
        ...
        csl.inspect({ type: csl.constant.notify, notification: csl.parseHTML(resource.attribute.ProgenitorInnerHTML + csv.progenitor.innerHTML), logtrace: csv.attribute.trace });
