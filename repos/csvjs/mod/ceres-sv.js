...
(function()
{
    ...
    function getSlideView()
    {
        ...
        csl.inspect({ type: csl.constant.notify, notification: resource.attribute.ProgenitorInnerHTML + DOMParser().parseFromString(csv.progenitor, "text/xml"), logtrace: csv.attribute.trace });
